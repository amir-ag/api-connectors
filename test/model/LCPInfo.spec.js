...
(function(root, factory) {
  ...
  describe('LCPInfo', function() {
    it('should create an instance of LCPInfo', function() {
      // uncomment below and update the code to test LCPInfo
      //var instance = new BybitApi.LCPInfo();
      //expect(instance).to.be.a(BybitApi.LCPInfo);
    });
