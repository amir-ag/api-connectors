...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.RiskLimitBase();
  });
  ...
  describe('RiskLimitBase', function() {
    it('should create an instance of RiskLimitBase', function() {
      // uncomment below and update the code to test RiskLimitBase
      //var instance = new BybitApi.RiskLimitBase();
      //expect(instance).to.be.a(BybitApi.RiskLimitBase);
    });
