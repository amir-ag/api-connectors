...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.Leverage();
  });
  ...
  describe('Leverage', function() {
    it('should create an instance of Leverage', function() {
      // uncomment below and update the code to test Leverage
      //var instance = new BybitApi.Leverage();
      //expect(instance).to.be.a(BybitApi.Leverage);
    });
    ...
    it('should have the property rateLimitStatus (base name: "rate_limit_status")', function() {
      // uncomment below and update the code to test the property rateLimitStatus
      //var instance = new BybitApi.Leverage();
      //expect(instance).to.be();
    });
