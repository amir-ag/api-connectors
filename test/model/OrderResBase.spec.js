...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.OrderResBase();
  });
  ...
  describe('OrderResBase', function() {
    it('should create an instance of OrderResBase', function() {
      // uncomment below and update the code to test OrderResBase
      //var instance = new BybitApi.OrderResBase();
      //expect(instance).to.be.a(BybitApi.OrderResBase);
    });
