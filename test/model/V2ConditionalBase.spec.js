...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.V2ConditionalBase();
  });
  ...
  describe('V2ConditionalBase', function() {
    it('should create an instance of V2ConditionalBase', function() {
      // uncomment below and update the code to test V2ConditionalBase
      //var instance = new BybitApi.V2ConditionalBase();
      //expect(instance).to.be.a(BybitApi.V2ConditionalBase);
    });
