...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearSetTradingStopResult();
  });
  ...
  describe('LinearSetTradingStopResult', function() {
    it('should create an instance of LinearSetTradingStopResult', function() {
      // uncomment below and update the code to test LinearSetTradingStopResult
      //var instance = new BybitApi.LinearSetTradingStopResult();
      //expect(instance).to.be.a(BybitApi.LinearSetTradingStopResult);
    });
