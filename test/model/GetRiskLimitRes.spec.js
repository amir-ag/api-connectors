...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.GetRiskLimitRes();
  });
  ...
  describe('GetRiskLimitRes', function() {
    it('should create an instance of GetRiskLimitRes', function() {
      // uncomment below and update the code to test GetRiskLimitRes
      //var instance = new BybitApi.GetRiskLimitRes();
      //expect(instance).to.be.a(BybitApi.GetRiskLimitRes);
    });
