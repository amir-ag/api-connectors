...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearPrevFundingResp();
  });
  ...
  describe('LinearPrevFundingResp', function() {
    it('should create an instance of LinearPrevFundingResp', function() {
      // uncomment below and update the code to test LinearPrevFundingResp
      //var instance = new BybitApi.LinearPrevFundingResp();
      //expect(instance).to.be.a(BybitApi.LinearPrevFundingResp);
    });
