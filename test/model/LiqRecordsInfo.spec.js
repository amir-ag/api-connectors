...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LiqRecordsInfo();
  });
  ...
  describe('LiqRecordsInfo', function() {
    it('should create an instance of LiqRecordsInfo', function() {
      // uncomment below and update the code to test LiqRecordsInfo
      //var instance = new BybitApi.LiqRecordsInfo();
      //expect(instance).to.be.a(BybitApi.LiqRecordsInfo);
    });
