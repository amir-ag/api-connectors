...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearListStopOrderResult();
  });
  ...
  describe('LinearListStopOrderResult', function() {
    it('should create an instance of LinearListStopOrderResult', function() {
      // uncomment below and update the code to test LinearListStopOrderResult
      //var instance = new BybitApi.LinearListStopOrderResult();
      //expect(instance).to.be.a(BybitApi.LinearListStopOrderResult);
    });
