...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearSetLeverageResult();
  });
  ...
  describe('LinearSetLeverageResult', function() {
    it('should create an instance of LinearSetLeverageResult', function() {
      // uncomment below and update the code to test LinearSetLeverageResult
      //var instance = new BybitApi.LinearSetLeverageResult();
      //expect(instance).to.be.a(BybitApi.LinearSetLeverageResult);
    });
