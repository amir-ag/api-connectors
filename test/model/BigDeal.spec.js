...
(function(root, factory) {
  ...
  describe('BigDeal', function() {
    it('should create an instance of BigDeal', function() {
      // uncomment below and update the code to test BigDeal
      //var instance = new BybitApi.BigDeal();
      //expect(instance).to.be.a(BybitApi.BigDeal);
    });
