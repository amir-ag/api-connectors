...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.ExchangeOrderListBase();
  });
  ...
  describe('ExchangeOrderListBase', function() {
    it('should create an instance of ExchangeOrderListBase', function() {
      // uncomment below and update the code to test ExchangeOrderListBase
      //var instance = new BybitApi.ExchangeOrderListBase();
      //expect(instance).to.be.a(BybitApi.ExchangeOrderListBase);
    });
