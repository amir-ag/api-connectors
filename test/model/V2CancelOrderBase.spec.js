...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.V2CancelOrderBase();
  });
  ...
  describe('V2CancelOrderBase', function() {
    it('should create an instance of V2CancelOrderBase', function() {
      // uncomment below and update the code to test V2CancelOrderBase
      //var instance = new BybitApi.V2CancelOrderBase();
      //expect(instance).to.be.a(BybitApi.V2CancelOrderBase);
    });
