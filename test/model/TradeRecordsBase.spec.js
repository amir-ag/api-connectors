...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.TradeRecordsBase();
  });
  ...
  describe('TradeRecordsBase', function() {
    it('should create an instance of TradeRecordsBase', function() {
      // uncomment below and update the code to test TradeRecordsBase
      //var instance = new BybitApi.TradeRecordsBase();
      //expect(instance).to.be.a(BybitApi.TradeRecordsBase);
    });
