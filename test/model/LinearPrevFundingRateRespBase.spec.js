...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearPrevFundingRateRespBase();
  });
  ...
  describe('LinearPrevFundingRateRespBase', function() {
    it('should create an instance of LinearPrevFundingRateRespBase', function() {
      // uncomment below and update the code to test LinearPrevFundingRateRespBase
      //var instance = new BybitApi.LinearPrevFundingRateRespBase();
      //expect(instance).to.be.a(BybitApi.LinearPrevFundingRateRespBase);
    });
