...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.ClosedPnlBase();
  });
  ...
  describe('ClosedPnlBase', function() {
    it('should create an instance of ClosedPnlBase', function() {
      // uncomment below and update the code to test ClosedPnlBase
      //var instance = new BybitApi.ClosedPnlBase();
      //expect(instance).to.be.a(BybitApi.ClosedPnlBase);
    });
