...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearRecentTradingRecordRespBase();
  });
  ...
  describe('LinearRecentTradingRecordRespBase', function() {
    it('should create an instance of LinearRecentTradingRecordRespBase', function() {
      // uncomment below and update the code to test LinearRecentTradingRecordRespBase
      //var instance = new BybitApi.LinearRecentTradingRecordRespBase();
      //expect(instance).to.be.a(BybitApi.LinearRecentTradingRecordRespBase);
    });
