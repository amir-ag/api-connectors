...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearStopOrderRecordsResponseBase();
  });
  ...
  describe('LinearStopOrderRecordsResponseBase', function() {
    it('should create an instance of LinearStopOrderRecordsResponseBase', function() {
      // uncomment below and update the code to test LinearStopOrderRecordsResponseBase
      //var instance = new BybitApi.LinearStopOrderRecordsResponseBase();
      //expect(instance).to.be.a(BybitApi.LinearStopOrderRecordsResponseBase);
    });
