...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.OrderCancelBase();
  });
  ...
  describe('OrderCancelBase', function() {
    it('should create an instance of OrderCancelBase', function() {
      // uncomment below and update the code to test OrderCancelBase
      //var instance = new BybitApi.OrderCancelBase();
      //expect(instance).to.be.a(BybitApi.OrderCancelBase);
    });
