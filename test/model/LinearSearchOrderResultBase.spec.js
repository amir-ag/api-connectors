...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearSearchOrderResultBase();
  });
  ...
  describe('LinearSearchOrderResultBase', function() {
    it('should create an instance of LinearSearchOrderResultBase', function() {
      // uncomment below and update the code to test LinearSearchOrderResultBase
      //var instance = new BybitApi.LinearSearchOrderResultBase();
      //expect(instance).to.be.a(BybitApi.LinearSearchOrderResultBase);
    });
