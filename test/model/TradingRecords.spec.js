...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.TradingRecords();
  });
  ...
  describe('TradingRecords', function() {
    it('should create an instance of TradingRecords', function() {
      // uncomment below and update the code to test TradingRecords
      //var instance = new BybitApi.TradingRecords();
      //expect(instance).to.be.a(BybitApi.TradingRecords);
    });
