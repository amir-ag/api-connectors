...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearSearchStopOrderResult();
  });
  ...
  describe('LinearSearchStopOrderResult', function() {
    it('should create an instance of LinearSearchStopOrderResult', function() {
      // uncomment below and update the code to test LinearSearchStopOrderResult
      //var instance = new BybitApi.LinearSearchStopOrderResult();
      //expect(instance).to.be.a(BybitApi.LinearSearchStopOrderResult);
    });
