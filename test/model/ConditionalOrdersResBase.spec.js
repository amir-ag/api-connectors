...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.ConditionalOrdersResBase();
  });
  ...
  describe('ConditionalOrdersResBase', function() {
    it('should create an instance of ConditionalOrdersResBase', function() {
      // uncomment below and update the code to test ConditionalOrdersResBase
      //var instance = new BybitApi.ConditionalOrdersResBase();
      //expect(instance).to.be.a(BybitApi.ConditionalOrdersResBase);
    });
