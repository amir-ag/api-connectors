...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LiqRecords();
  });
  ...
  describe('LiqRecords', function() {
    it('should create an instance of LiqRecords', function() {
      // uncomment below and update the code to test LiqRecords
      //var instance = new BybitApi.LiqRecords();
      //expect(instance).to.be.a(BybitApi.LiqRecords);
    });
