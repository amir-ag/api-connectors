...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.V2ConditionalRes();
  });
  ...
  describe('V2ConditionalRes', function() {
    it('should create an instance of V2ConditionalRes', function() {
      // uncomment below and update the code to test V2ConditionalRes
      //var instance = new BybitApi.V2ConditionalRes();
      //expect(instance).to.be.a(BybitApi.V2ConditionalRes);
    });
