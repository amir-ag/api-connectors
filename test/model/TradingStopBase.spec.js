...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.TradingStopBase();
  });
  ...
  describe('TradingStopBase', function() {
    it('should create an instance of TradingStopBase', function() {
      // uncomment below and update the code to test TradingStopBase
      //var instance = new BybitApi.TradingStopBase();
      //expect(instance).to.be.a(BybitApi.TradingStopBase);
    });
