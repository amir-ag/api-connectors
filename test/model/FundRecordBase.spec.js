...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.FundRecordBase();
  });
  ...
  describe('FundRecordBase', function() {
    it('should create an instance of FundRecordBase', function() {
      // uncomment below and update the code to test FundRecordBase
      //var instance = new BybitApi.FundRecordBase();
      //expect(instance).to.be.a(BybitApi.FundRecordBase);
    });
