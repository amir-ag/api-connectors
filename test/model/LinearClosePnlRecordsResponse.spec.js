...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearClosePnlRecordsResponse();
  });
  ...
  describe('LinearClosePnlRecordsResponse', function() {
    it('should create an instance of LinearClosePnlRecordsResponse', function() {
      // uncomment below and update the code to test LinearClosePnlRecordsResponse
      //var instance = new BybitApi.LinearClosePnlRecordsResponse();
      //expect(instance).to.be.a(BybitApi.LinearClosePnlRecordsResponse);
    });
