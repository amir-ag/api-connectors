...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.ServerTime();
  });
  ...
  describe('ServerTime', function() {
    it('should create an instance of ServerTime', function() {
      // uncomment below and update the code to test ServerTime
      //var instance = new BybitApi.ServerTime();
      //expect(instance).to.be.a(BybitApi.ServerTime);
    });
