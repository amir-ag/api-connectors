...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearKlineRespBase();
  });
  ...
  describe('LinearKlineRespBase', function() {
    it('should create an instance of LinearKlineRespBase', function() {
      // uncomment below and update the code to test LinearKlineRespBase
      //var instance = new BybitApi.LinearKlineRespBase();
      //expect(instance).to.be.a(BybitApi.LinearKlineRespBase);
    });
