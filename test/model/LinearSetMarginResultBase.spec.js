...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearSetMarginResultBase();
  });
  ...
  describe('LinearSetMarginResultBase', function() {
    it('should create an instance of LinearSetMarginResultBase', function() {
      // uncomment below and update the code to test LinearSetMarginResultBase
      //var instance = new BybitApi.LinearSetMarginResultBase();
      //expect(instance).to.be.a(BybitApi.LinearSetMarginResultBase);
    });
