...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearStopOrderRecordsResponse();
  });
  ...
  describe('LinearStopOrderRecordsResponse', function() {
    it('should create an instance of LinearStopOrderRecordsResponse', function() {
      // uncomment below and update the code to test LinearStopOrderRecordsResponse
      //var instance = new BybitApi.LinearStopOrderRecordsResponse();
      //expect(instance).to.be.a(BybitApi.LinearStopOrderRecordsResponse);
    });
