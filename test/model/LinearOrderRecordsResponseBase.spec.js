...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearOrderRecordsResponseBase();
  });
  ...
  describe('LinearOrderRecordsResponseBase', function() {
    it('should create an instance of LinearOrderRecordsResponseBase', function() {
      // uncomment below and update the code to test LinearOrderRecordsResponseBase
      //var instance = new BybitApi.LinearOrderRecordsResponseBase();
      //expect(instance).to.be.a(BybitApi.LinearOrderRecordsResponseBase);
    });
