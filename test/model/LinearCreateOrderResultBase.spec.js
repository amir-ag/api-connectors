...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearCreateOrderResultBase();
  });
  ...
  describe('LinearCreateOrderResultBase', function() {
    it('should create an instance of LinearCreateOrderResultBase', function() {
      // uncomment below and update the code to test LinearCreateOrderResultBase
      //var instance = new BybitApi.LinearCreateOrderResultBase();
      //expect(instance).to.be.a(BybitApi.LinearCreateOrderResultBase);
    });
