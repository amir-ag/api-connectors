...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearCancelOrderResultBase();
  });
  ...
  describe('LinearCancelOrderResultBase', function() {
    it('should create an instance of LinearCancelOrderResultBase', function() {
      // uncomment below and update the code to test LinearCancelOrderResultBase
      //var instance = new BybitApi.LinearCancelOrderResultBase();
      //expect(instance).to.be.a(BybitApi.LinearCancelOrderResultBase);
    });
