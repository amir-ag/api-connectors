...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearStopOrderReplace();
  });
  ...
  describe('LinearStopOrderReplace', function() {
    it('should create an instance of LinearStopOrderReplace', function() {
      // uncomment below and update the code to test LinearStopOrderReplace
      //var instance = new BybitApi.LinearStopOrderReplace();
      //expect(instance).to.be.a(BybitApi.LinearStopOrderReplace);
    });
