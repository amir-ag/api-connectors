...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearStopOrderCancelAllBase();
  });
  ...
  describe('LinearStopOrderCancelAllBase', function() {
    it('should create an instance of LinearStopOrderCancelAllBase', function() {
      // uncomment below and update the code to test LinearStopOrderCancelAllBase
      //var instance = new BybitApi.LinearStopOrderCancelAllBase();
      //expect(instance).to.be.a(BybitApi.LinearStopOrderCancelAllBase);
    });
