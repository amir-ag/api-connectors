...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.OrderBookBase();
  });
  ...
  describe('OrderBookBase', function() {
    it('should create an instance of OrderBookBase', function() {
      // uncomment below and update the code to test OrderBookBase
      //var instance = new BybitApi.OrderBookBase();
      //expect(instance).to.be.a(BybitApi.OrderBookBase);
    });
