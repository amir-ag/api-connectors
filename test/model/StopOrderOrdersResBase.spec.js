...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.StopOrderOrdersResBase();
  });
  ...
  describe('StopOrderOrdersResBase', function() {
    it('should create an instance of StopOrderOrdersResBase', function() {
      // uncomment below and update the code to test StopOrderOrdersResBase
      //var instance = new BybitApi.StopOrderOrdersResBase();
      //expect(instance).to.be.a(BybitApi.StopOrderOrdersResBase);
    });
