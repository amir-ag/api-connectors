...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearOrderCancelAllBase();
  });
  ...
  describe('LinearOrderCancelAllBase', function() {
    it('should create an instance of LinearOrderCancelAllBase', function() {
      // uncomment below and update the code to test LinearOrderCancelAllBase
      //var instance = new BybitApi.LinearOrderCancelAllBase();
      //expect(instance).to.be.a(BybitApi.LinearOrderCancelAllBase);
    });
