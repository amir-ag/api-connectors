...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearTradeRecordsResponse();
  });
  ...
  describe('LinearTradeRecordsResponse', function() {
    it('should create an instance of LinearTradeRecordsResponse', function() {
      // uncomment below and update the code to test LinearTradeRecordsResponse
      //var instance = new BybitApi.LinearTradeRecordsResponse();
      //expect(instance).to.be.a(BybitApi.LinearTradeRecordsResponse);
    });
