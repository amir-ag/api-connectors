...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.OpenInterest();
  });
  ...
  describe('OpenInterest', function() {
    it('should create an instance of OpenInterest', function() {
      // uncomment below and update the code to test OpenInterest
      //var instance = new BybitApi.OpenInterest();
      //expect(instance).to.be.a(BybitApi.OpenInterest);
    });
