...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.KlineBase();
  });
  ...
  describe('KlineBase', function() {
    it('should create an instance of KlineBase', function() {
      // uncomment below and update the code to test KlineBase
      //var instance = new BybitApi.KlineBase();
      //expect(instance).to.be.a(BybitApi.KlineBase);
    });
