...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearPrevFundingRespBase();
  });
  ...
  describe('LinearPrevFundingRespBase', function() {
    it('should create an instance of LinearPrevFundingRespBase', function() {
      // uncomment below and update the code to test LinearPrevFundingRespBase
      //var instance = new BybitApi.LinearPrevFundingRespBase();
      //expect(instance).to.be.a(BybitApi.LinearPrevFundingRespBase);
    });
