...
(function(root, factory) {
  ...
  describe('Symbols', function() {
    it('should create an instance of Symbols', function() {
      // uncomment below and update the code to test Symbols
      //var instance = new BybitApi.Symbols();
      //expect(instance).to.be.a(BybitApi.Symbols);
    });
