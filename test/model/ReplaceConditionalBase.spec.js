...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.ReplaceConditionalBase();
  });
  ...
  describe('ReplaceConditionalBase', function() {
    it('should create an instance of ReplaceConditionalBase', function() {
      // uncomment below and update the code to test ReplaceConditionalBase
      //var instance = new BybitApi.ReplaceConditionalBase();
      //expect(instance).to.be.a(BybitApi.ReplaceConditionalBase);
    });
