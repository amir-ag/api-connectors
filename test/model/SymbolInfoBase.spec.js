...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.SymbolInfoBase();
  });
  ...
  describe('SymbolInfoBase', function() {
    it('should create an instance of SymbolInfoBase', function() {
      // uncomment below and update the code to test SymbolInfoBase
      //var instance = new BybitApi.SymbolInfoBase();
      //expect(instance).to.be.a(BybitApi.SymbolInfoBase);
    });
