...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearCreateStopOrderResultBase();
  });
  ...
  describe('LinearCreateStopOrderResultBase', function() {
    it('should create an instance of LinearCreateStopOrderResultBase', function() {
      // uncomment below and update the code to test LinearCreateStopOrderResultBase
      //var instance = new BybitApi.LinearCreateStopOrderResultBase();
      //expect(instance).to.be.a(BybitApi.LinearCreateStopOrderResultBase);
    });
