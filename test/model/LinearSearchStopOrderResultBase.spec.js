...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearSearchStopOrderResultBase();
  });
  ...
  describe('LinearSearchStopOrderResultBase', function() {
    it('should create an instance of LinearSearchStopOrderResultBase', function() {
      // uncomment below and update the code to test LinearSearchStopOrderResultBase
      //var instance = new BybitApi.LinearSearchStopOrderResultBase();
      //expect(instance).to.be.a(BybitApi.LinearSearchStopOrderResultBase);
    });
