...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.WithdrawResBase();
  });
  ...
  describe('WithdrawResBase', function() {
    it('should create an instance of WithdrawResBase', function() {
      // uncomment below and update the code to test WithdrawResBase
      //var instance = new BybitApi.WithdrawResBase();
      //expect(instance).to.be.a(BybitApi.WithdrawResBase);
    });
