...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.AccountRatio();
  });
  ...
  describe('AccountRatio', function() {
    it('should create an instance of AccountRatio', function() {
      // uncomment below and update the code to test AccountRatio
      //var instance = new BybitApi.AccountRatio();
      //expect(instance).to.be.a(BybitApi.AccountRatio);
    });
