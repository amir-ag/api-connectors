...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearCancelStopOrderResultBase();
  });
  ...
  describe('LinearCancelStopOrderResultBase', function() {
    it('should create an instance of LinearCancelStopOrderResultBase', function() {
      // uncomment below and update the code to test LinearCancelStopOrderResultBase
      //var instance = new BybitApi.LinearCancelStopOrderResultBase();
      //expect(instance).to.be.a(BybitApi.LinearCancelStopOrderResultBase);
    });
