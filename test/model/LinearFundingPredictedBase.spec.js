...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearFundingPredictedBase();
  });
  ...
  describe('LinearFundingPredictedBase', function() {
    it('should create an instance of LinearFundingPredictedBase', function() {
      // uncomment below and update the code to test LinearFundingPredictedBase
      //var instance = new BybitApi.LinearFundingPredictedBase();
      //expect(instance).to.be.a(BybitApi.LinearFundingPredictedBase);
    });
