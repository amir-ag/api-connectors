...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.OrderCancelAllBase();
  });
  ...
  describe('OrderCancelAllBase', function() {
    it('should create an instance of OrderCancelAllBase', function() {
      // uncomment below and update the code to test OrderCancelAllBase
      //var instance = new BybitApi.OrderCancelAllBase();
      //expect(instance).to.be.a(BybitApi.OrderCancelAllBase);
    });
