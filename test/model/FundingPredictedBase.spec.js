...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.FundingPredictedBase();
  });
  ...
  describe('FundingPredictedBase', function() {
    it('should create an instance of FundingPredictedBase', function() {
      // uncomment below and update the code to test FundingPredictedBase
      //var instance = new BybitApi.FundingPredictedBase();
      //expect(instance).to.be.a(BybitApi.FundingPredictedBase);
    });
