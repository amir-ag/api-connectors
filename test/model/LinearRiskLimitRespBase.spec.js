...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearRiskLimitRespBase();
  });
  ...
  describe('LinearRiskLimitRespBase', function() {
    it('should create an instance of LinearRiskLimitRespBase', function() {
      // uncomment below and update the code to test LinearRiskLimitRespBase
      //var instance = new BybitApi.LinearRiskLimitRespBase();
      //expect(instance).to.be.a(BybitApi.LinearRiskLimitRespBase);
    });
