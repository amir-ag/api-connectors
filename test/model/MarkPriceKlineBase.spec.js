...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.MarkPriceKlineBase();
  });
  ...
  describe('MarkPriceKlineBase', function() {
    it('should create an instance of MarkPriceKlineBase', function() {
      // uncomment below and update the code to test MarkPriceKlineBase
      //var instance = new BybitApi.MarkPriceKlineBase();
      //expect(instance).to.be.a(BybitApi.MarkPriceKlineBase);
    });
