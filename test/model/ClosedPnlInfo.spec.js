...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.ClosedPnlInfo();
  });
  ...
  describe('ClosedPnlInfo', function() {
    it('should create an instance of ClosedPnlInfo', function() {
      // uncomment below and update the code to test ClosedPnlInfo
      //var instance = new BybitApi.ClosedPnlInfo();
      //expect(instance).to.be.a(BybitApi.ClosedPnlInfo);
    });
