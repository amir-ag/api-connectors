...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.SetRiskLimitBase();
  });
  ...
  describe('SetRiskLimitBase', function() {
    it('should create an instance of SetRiskLimitBase', function() {
      // uncomment below and update the code to test SetRiskLimitBase
      //var instance = new BybitApi.SetRiskLimitBase();
      //expect(instance).to.be.a(BybitApi.SetRiskLimitBase);
    });
