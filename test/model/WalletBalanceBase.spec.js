...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.WalletBalanceBase();
  });
  ...
  describe('WalletBalanceBase', function() {
    it('should create an instance of WalletBalanceBase', function() {
      // uncomment below and update the code to test WalletBalanceBase
      //var instance = new BybitApi.WalletBalanceBase();
      //expect(instance).to.be.a(BybitApi.WalletBalanceBase);
    });
