...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearTradeRecordItem();
  });
  ...
  describe('LinearTradeRecordItem', function() {
    it('should create an instance of LinearTradeRecordItem', function() {
      // uncomment below and update the code to test LinearTradeRecordItem
      //var instance = new BybitApi.LinearTradeRecordItem();
      //expect(instance).to.be.a(BybitApi.LinearTradeRecordItem);
    });
