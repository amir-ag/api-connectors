...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearOrderReplace();
  });
  ...
  describe('LinearOrderReplace', function() {
    it('should create an instance of LinearOrderReplace', function() {
      // uncomment below and update the code to test LinearOrderReplace
      //var instance = new BybitApi.LinearOrderReplace();
      //expect(instance).to.be.a(BybitApi.LinearOrderReplace);
    });
