...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.FundingRateBase();
  });
  ...
  describe('FundingRateBase', function() {
    it('should create an instance of FundingRateBase', function() {
      // uncomment below and update the code to test FundingRateBase
      //var instance = new BybitApi.FundingRateBase();
      //expect(instance).to.be.a(BybitApi.FundingRateBase);
    });
