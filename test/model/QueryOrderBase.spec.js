...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.QueryOrderBase();
  });
  ...
  describe('QueryOrderBase', function() {
    it('should create an instance of QueryOrderBase', function() {
      // uncomment below and update the code to test QueryOrderBase
      //var instance = new BybitApi.QueryOrderBase();
      //expect(instance).to.be.a(BybitApi.QueryOrderBase);
    });
