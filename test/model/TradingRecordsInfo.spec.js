...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.TradingRecordsInfo();
  });
  ...
  describe('TradingRecordsInfo', function() {
    it('should create an instance of TradingRecordsInfo', function() {
      // uncomment below and update the code to test TradingRecordsInfo
      //var instance = new BybitApi.TradingRecordsInfo();
      //expect(instance).to.be.a(BybitApi.TradingRecordsInfo);
    });
