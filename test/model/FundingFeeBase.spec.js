...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.FundingFeeBase();
  });
  ...
  describe('FundingFeeBase', function() {
    it('should create an instance of FundingFeeBase', function() {
      // uncomment below and update the code to test FundingFeeBase
      //var instance = new BybitApi.FundingFeeBase();
      //expect(instance).to.be.a(BybitApi.FundingFeeBase);
    });
