...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.LinearSwitchIsolatedResult();
  });
  ...
  describe('LinearSwitchIsolatedResult', function() {
    it('should create an instance of LinearSwitchIsolatedResult', function() {
      // uncomment below and update the code to test LinearSwitchIsolatedResult
      //var instance = new BybitApi.LinearSwitchIsolatedResult();
      //expect(instance).to.be.a(BybitApi.LinearSwitchIsolatedResult);
    });
