...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.APIKeyBase();
  });
  ...
  describe('APIKeyBase', function() {
    it('should create an instance of APIKeyBase', function() {
      // uncomment below and update the code to test APIKeyBase
      //var instance = new BybitApi.APIKeyBase();
      //expect(instance).to.be.a(BybitApi.APIKeyBase);
    });
