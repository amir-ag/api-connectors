...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.V2OrderRes();
  });
  ...
  describe('V2OrderRes', function() {
    it('should create an instance of V2OrderRes', function() {
      // uncomment below and update the code to test V2OrderRes
      //var instance = new BybitApi.V2OrderRes();
      //expect(instance).to.be.a(BybitApi.V2OrderRes);
    });
