...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.ConditionalCancelAllBase();
  });
  ...
  describe('ConditionalCancelAllBase', function() {
    it('should create an instance of ConditionalCancelAllBase', function() {
      // uncomment below and update the code to test ConditionalCancelAllBase
      //var instance = new BybitApi.ConditionalCancelAllBase();
      //expect(instance).to.be.a(BybitApi.ConditionalCancelAllBase);
    });
