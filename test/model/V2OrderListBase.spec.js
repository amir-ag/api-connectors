...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.V2OrderListBase();
  });
  ...
  describe('V2OrderListBase', function() {
    it('should create an instance of V2OrderListBase', function() {
      // uncomment below and update the code to test V2OrderListBase
      //var instance = new BybitApi.V2OrderListBase();
      //expect(instance).to.be.a(BybitApi.V2OrderListBase);
    });
